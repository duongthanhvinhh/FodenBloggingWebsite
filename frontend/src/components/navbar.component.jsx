    ...
    return(
        <nav className="navbar">
            ...
            <div className={"absolute bg-white w-full left-0 top-full mt-0.5 border-b border-grey py-4 px-[5vw] md:border-0 md:block md:relative md:inset-0 md:p-0 md:w-auto md:show "
                ...
                />
                <CiSearch className="absolute right-[10%] md:pointer-events-none md:left-5 top-1/2 -translate-y-1/2 text-2xl text-dark-grey"/>
            </div>
            ...
            <div className="flex items-center gap-3 md:gap-6 ml-auto">
                ...
                <Link className="btn-dark by-2" to="/signin">
                    Sign In
                </Link>
                <Link className="btn-light by-2 hidden md:block" to="/signup">
                    Sign Up
                </Link>
            </div>
        </nav> 
